...
<div class="col-xl-12 mb-30">
    <div class="card card-statistics h-100">
        <div class="card-body">
            ...
            <button type="button" class="button x-small" id="btn_delete_all">  {{-- حذف الصفوف المختارة --}}
            ...
            <br><br>
                ...
                <form action="{{ route('Filter_Classes') }}" method="POST">
                    ...
                    <select class="selectpicker" data-style="btn-info" name="Grade_id" required
                            onchange="this.form.submit()">  {{-- وقت بيختار اوبشن بيعمل submit --}}
            ...
            <div class="table-responsive">
                <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
                    ...
                    <thead>
                        <tr>
                            <th><input name="select_all" id="example-select-all" type="checkbox" onclick="CheckAll('box1', this)" /></th> {{-- check all box1 in foreach --}}
                            <th>#</th>
                    ...
                    @if (isset($details))  // withDetails in controller
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class=" row mb-30" action="{{ route('Classrooms.store') }}" method="POST">
                    ...
                    <div class="card-body">
                        <div class="repeater">
                            <div data-repeater-list="List_Classes">  {{-- array نعتبرها --}}
    ...
    $(function() {
        $("#btn_delete_all").click(function() {
            ...
            $("#datatable input[type=checkbox]:checked").each(function() {
                selected.push(this.value);  // بياخد الفاليو تبع التشيك بوكس
            });

            if (selected.length > 0) {  // لو في تشيك بطالع الرسالة
                $('#delete_all').modal('show')
                $('input[id="delete_all_id"]').val(selected);  //بياخد اي دي الصفوف التشيكد
            }
        });
    });
...
{{-- كود التشيك بوكس بالفوتر --}}

{{-- add button can be implemented with livewire in codechef website --}}

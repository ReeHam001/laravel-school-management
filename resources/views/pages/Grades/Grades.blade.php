                ...
                <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
                    ...
                    <tbody>
                        ...
                        @foreach ($Grades as $Grade)
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        ...
                                                        <input id="Name" type="text" name="Name"
                                                                class="form-control"
                                                                value="{{ $Grade->getTranslation('Name', 'ar') }}"  {{-- get the translation for column Name from Grade table --}}
                                                                required>
                            ...
                            <!-- delete_modal_Grade inside foreach -->
...
<!-- add_modal_Grade outside foreach -->

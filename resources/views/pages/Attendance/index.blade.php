            ...
            @foreach ($students as $student)
                <tr>
                    ...
                    <td>
                        ...
                        @if(isset($student->attendance()->where('attendence_date',date('Y-m-d'))->first()->student_id))  {{-- تاريخ الحضور هو تاريخ اليوم بجيب اي ديات الطلاب --}}

                            <label class="block text-gray-500 font-semibold sm:border-r sm:pr-4">   {{-- disabled اذا في حضور وغياب بالداتا بحط الزر --}}

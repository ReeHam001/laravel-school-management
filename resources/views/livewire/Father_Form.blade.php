@if($currentStep != 1)  {{-- اخفاء الفورم لو ما كنا بالخطوة الاولى --}}
            ...
            <div class="col-md-12">
                ...
                <div class="form-row">
                    <div class="col">
                        ...
                        <input type="email" wire:model="Email"  class="form-control"> {{--  wire:model="Email" instead of name , you have to declair in controller --}}
                ...
                @else
                    <button class="btn btn-success btn-sm nextBtn btn-lg pull-right" wire:click="firstStepSubmit" {{-- go to method firstStepSubmit --}}
                            type="button">{{trans('Parent_trans.Next')}}
                    </button>
                @endif

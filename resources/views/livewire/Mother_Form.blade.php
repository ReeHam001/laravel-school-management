    ...
    <div style="display: none" class="row setup-content" id="step-2">
        ...
        <div class="col-xs-12">
            <div class="col-md-12">
                ...
                <button class="btn btn-danger btn-sm nextBtn btn-lg pull-right" type="button" wire:click="back(1)"> {{-- back is method in controller زر السابق ارجع للخوة رقم 1 --}}
                    {{trans('Parent_trans.Back')}}
                </button>

                @if($updateMode)
                    <button class="btn btn-success btn-sm nextBtn btn-lg pull-right" wire:click="secondStepSubmit_edit"  {{-- go to method secondStepSubmit_edit --}}

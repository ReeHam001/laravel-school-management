...
class QuizzRepository implements QuizzRepositoryInterface
{
    ...
    public function create()
    {
        ...
        return view('pages.Quizzes.create', $data);  //بيقدر بشوف الاسماء بدون الداتا
    }
    ...
    public function store($request)
    {
        try {
            ...
            $quizzes = new Quizze(); // create is better for security
    ...
    {
        $quizz = Quizze::findorFail($id);  // when fail it shows 404 page
        $data['grades'] = Grade::all();
        $data['subjects'] = Subject::all();
        $data['teachers'] = Teacher::all();

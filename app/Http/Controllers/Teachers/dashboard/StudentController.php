...
class StudentController extends Controller
{
    ...
    {   // query builder is faster than elquent
    ...
    public function attendance(Request $request)
    {
        ...
        try {
            ...
            foreach ($request->attendences as $studentid => $attendence) {
                ...
                Attendance::updateorCreate(       // متل  if else
                    ['student_id'=> $studentid ,     // متل where
    ...
    // updateorCreate بما انها موجود معد في داعي لتابع التعديل
    ...
    public function attendanceSearch(Request $request){
        ...
        $request->validate([
            ...
            'to'=> 'required|date|date_format:Y-m-d|after_or_equal:from'  // after_or_equal
        ],[
...
// attendance()  هو بعدل عالداتا لذلك التقارير بجيبها عالجديد
// المفروض يدخل كل التواريخ

...
class Student extends Authenticatable  //Model  بيقبل نظام اوث خاص
{
    use SoftDeletes;
    ...
    public function images()  // الطالب له اكثر من صورة
    {
        return $this->morphMany('App\Models\Image', 'imageable'); // imageable متل المفتاح الاجنبي
    }
